...
function khakehashi_setup() {
	/*
		...
		* If you're building a theme based on khakehashi, use a find and replace
		* to change 'khakehashi' to the name of your theme in all the template files.
		*/
...
function khakehashi_scripts() {
    ...
    // Load main theme stylesheet (style.css)
    wp_enqueue_style(
        'khakehashi-style',
        get_stylesheet_uri(),
        array(),
    ...
    // Load YOUR Tailwind build output
    wp_enqueue_style(
        'khakehashi-custom',
    ...
    // Load navigation.js (Underscores default)
    wp_enqueue_script(
